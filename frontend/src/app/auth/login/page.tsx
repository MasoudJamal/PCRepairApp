...
export default function LoginPage() {
  ...
  .select(`
    ...
    showroom:showrooms!users_showroom_id_fkey (
      id,
      name,
      address,
      logo_url,
  ...
  .single();
    ...
    // Normalize showroom (Supabase returns array)

const showroom = Array.isArray(user.showroom)
  ? user.showroom[0]
  : user.showroom ?? null;
    ...
    if (!showroom) {
      setError(
        lang === "en"
          ...
          : "Aucun showroom assigné à cet utilisateur."
      );
      await supabase.auth.signOut();
      return;
    }
    ...
    setSession({
      ...
      showroom: showroom
        ? {
            ...
            currency_code: showroom.currency_code,
          }
        : null,
    });
